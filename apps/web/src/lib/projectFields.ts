...
export const FIELD_LABELS: Record<string, string> = {
  ...
  date_customer_received_doc1: 'Tanggal Terima SP Customer',
  date_customer_received_doc2: 'Tanggal Terima PO/PKS Customer',
  doc2_number_id: 'No PO/PKS Customer',
  customer_price: 'Nilai PO/PKS Customer',
  customer_start_contract: 'Start Contract - Cust',
  customer_end_contract: 'End Contract - Cust',
  vendor_name: 'Vendor name',
  vendor_revenue: 'Nilai RAB',
  vendor_type: 'Vendor type',
  project_sent_date: 'Tanggal Kirim FPT',
  project_finish_date: 'Tgl Finish FPT',
  vendor_project_id: 'No FPT',
  negotiation_date: 'Tanggal Nego Vendor',
  approval_date: 'Tanggal Terima SP Vendor',
  document_sent_date: 'Tanggal kirim PO/PKS vendor',
  document_id: 'No PO/PKS Vendor',
  vendor_price: 'Nilai PO/PKS Vendor',
  vendor_start_contract: 'Start Contract - Vendor',
  vendor_end_contract: 'End Contract2 - Vendor',
  current_stage: 'Stage',
  pic_id: 'PIC',
  issues: 'Issues',
};
